...
class CelestialBody:
    def __init__(self, name: str, position: np.ndarray[np.float64], velocity: np.ndarray[np.float64], mass: float, color: str, orbital_period: float = None, eccentricity: float = None):
        self.name = name
