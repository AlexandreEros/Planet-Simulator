...
class Planet(CelestialBody):
    def __init__(self, name: str, body_type: str, radius: float, resolution: int, position: np.ndarray, velocity: np.ndarray, mass: float,
        ...
        try:
            ...
            self.surface = Surface(self.radius, resolution)
